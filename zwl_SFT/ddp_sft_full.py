...
def init_model():
    ...
    # 加载分词器 zzzwl
    tokenizer = AutoTokenizer.from_pretrained('./tokenizer_k/',local_files_only=True) #存入的是当前的相对路径

    # 初始化模型
    model = Transformer(lm_config)

    # 加载预训练权重  zzzzwl
    ckp = './model_base/pretrain_1024_18_6144.pth'  #存入的是当前的相对路径
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="./zzzwl_model_sft", help="输出目录")
    parser.add_argument("--data_path", type=str, default="/mnt/data/zzzwl/happy-llm/zwl_mymodel/zwl_dataset_dir/BelleGroup_sft.jsonl", help="训练数据路径")
    ...
    parser.add_argument("--gpus", type=str, default='0,1', help="逗号分隔的GPU ID (例如 '0,1,2')") #只有两张卡
